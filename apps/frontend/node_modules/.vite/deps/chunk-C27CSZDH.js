...
function tryResolveSync(promise) {
  var _a4;
  let data;
  (_a4 = promise.then((result) => {
    data = result;
    return result;
  }, noop)) == null ? void 0 : _a4.catch(noop);
  if (data !== void 0) {
    return { data };
  }
  return void 0;
...
function dehydrateQuery(query, serializeData, shouldRedactErrors) {
  ...
  return {
    ...
    ...query.state.status === "pending" && {
      promise: (_a4 = query.promise) == null ? void 0 : _a4.then(serializeData).catch((error) => {
...
function dehydrate(client, options = {}) {
  var _a4, _b, _c, _d;
  const filterMutation = options.shouldDehydrateMutation ?? ((_a4 = client.getDefaultOptions().dehydrate) == null ? void 0 : _a4.shouldDehydrateMutation) ?? defaultShouldDehydrateMutation;
...
function hydrate(client, dehydratedState, options) {
  ...
  const deserializeData = ((_a4 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _a4.deserializeData) ?? ((_b = client.getDefaultOptions().hydrate) == null ? void 0 : _b.deserializeData) ?? defaultTransformerFn;
  ...
  mutations.forEach(({ state, ...mutationOptions }) => {
    ...
    mutationCache.build(
      client,
      {
        ...(_a5 = client.getDefaultOptions().hydrate) == null ? void 0 : _a5.mutations,
    ...
    ({ queryKey, state, queryHash, meta, promise, dehydratedAt }) => {
      ...
      if (query) {
        ...
        query = queryCache.build(
          client,
          {
            ...(_a5 = client.getDefaultOptions().hydrate) == null ? void 0 : _a5.queries,
...
//# sourceMappingURL=chunk-C27CSZDH.js.map

...
A decentralized marketplace for selling digital products built on VeChain using React and Solidity.

## Deployed Contract (Testnet)

**DigitalProductStore Contract Address:** `0xaA302b8DDEd08CD0B97e785F0c2de35034de2040`

**Deployer Address:** `0xf077b491b355E64048cE21E3A6Fc4751eEeA77fa`

**Network:** VeChain Testnet

**View Transactions:**
- Contract: https://explore-testnet.vechain.org/accounts/0xaA302b8DDEd08CD0B97e785F0c2de35034de2040
- Deployer: https://explore-testnet.vechain.org/accounts/0xf077b491b355E64048cE21E3A6Fc4751eEeA77fa

## Features

- Add digital products with name, download link, price, and seller wallet
- Purchase products with VET - payment goes directly to seller
- Automatic access control (only buyers can see download links)
- Sellers can deactivate their own products
- No middleman fees - peer-to-peer transactions

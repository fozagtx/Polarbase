 ...
 * Error code type.
 */
type ErrorCode = SECP256K1 | ADDRESS | KEYSTORE | HDNODE | BLOOM | CERTIFICATE | ABI | RLP | DATA | TRANSACTION | HTTP_CLIENT | POLL_ERROR | FUNCTION | EIP1193 | JSONRPC | CONTRACT;
/**
 ...
 */
declare class InvalidRLPError extends ErrorBase<RLP.INVALID_RLP, InvalidRLPErrorData> {
}
/**
 * Errors enum.
 */
...
type errors_RLP = RLP;
declare const errors_RLP: typeof RLP;

import { TransactionBody as TransactionBody$1, EventFragment as EventFragment$1, Result, TransactionClause, Transaction, vechain_sdk_core_ethers, InterfaceAbi, FunctionFragment, DeployParams } from '@vechain/sdk-core';
...
declare class TransactionsModule {
     ...
     */
    decodeRevertReason(encodedRevertReason: string): string;
    /**
     ...
     */
    getRevertReason(transactionHash: string): Promise<string | null>;
}
 ...
 */
declare class VechainBaseSigner implements VechainSigner {
     ...
     *  @returns the result of the evaluation
     */
    call(transactionToEvaluate: TransactionRequestInput, revision?: string): Promise<TransactionSimulationResult[]>;
    /**
     *  Gets the next nonce required for this Signer to send a transaction.
     *
     *  @param blockTag - The blocktag to base the transaction count on, keep in mind
...
declare class Contract {
    ...
    filters: ContractFunctionFilter;
    clause: ContractFunctionClause;
    criteria: ContractFunctionCriteria;
...
declare class ContractsModule {
     ...
     */
    createContractFactory(abi: InterfaceAbi, bytecode: string, signer: VechainSigner): ContractFactory;
    /**
     ...
     */
    load(address: string, abi: InterfaceAbi, signer?: VechainSigner): Contract;
    /**
     ...
     * @private
     */
    private _signContractTransaction;
    /**
     ...
     * @param options - (Optional) An object containing options for the transaction body. Includes all options of the `buildTransactionBody` method
     */
    executeMultipleClausesTransaction(clauses: ContractClause[], signer: VechainSigner, options?: ContractTransactionOptions): Promise<SendTransactionResult>;
    /**
 ...
 */
declare class ProviderInternalBaseWallet implements ProviderInternalWallet {
    /**
     * List of accounts in the wallet.
     */
     ...
     * @returns The signer for the given address.
     */
    getSigner(parentProvider: AvailableVechainProviders, address: string): Promise<VechainSigner | null>;
    /**
     * Get the list of addresses in the wallet.
     *
     * @returns The list of addresses in the wallet.
     ...
     * @returns The account with the given address, or null if not found.
     */
    getAccount(address: string): Promise<ProviderInternalWalletAccount | null>;
    /**
     * Get the options for signing a transaction with delegator (if any).
     *
     * @returns The options for signing a transaction with delegator.
...
declare class VechainProvider extends EventEmitter implements EIP1193ProviderMessage {
     ...
     * @returns The signer for the given address.
     */
    getSigner(address: string): Promise<VechainSigner | null>;
    /**
     * Use vet.domains to resolve name to adress
     * @param vnsName - The name to resolve
     * @returns the address for a name or null
...
declare const transactionsFormatter: {
    ...
    formatSendRawTransactionToRPCStandard: (transaction: SendTransactionResult) => string;
};
...
declare const blocksFormatter: {
    formatToRPCStandard: (block: ExpandedBlockDetail | CompressedBlockDetail, chainId: string) => BlocksRPC;
};
...
type network_ContractFunctionAsync<T = unknown> = ContractFunctionAsync<T>;
...
type network_VechainBaseSigner = VechainBaseSigner;
declare const network_VechainBaseSigner: typeof VechainBaseSigner;

...
import { assert as assert8, RLP as RLPError2 } from "@vechain/sdk-errors";
...
import { assert as assert7, RLP as RLPError, RLP } from "@vechain/sdk-errors";
...
import { assert as assert9, RLP as RLP3 } from "@vechain/sdk-errors";
...
import { assert as assert10, RLP as RLP4 } from "@vechain/sdk-errors";
...
import { assert as assert11, RLP as RLP5 } from "@vechain/sdk-errors";
...
import { assert as assert12, RLP as RLP6 } from "@vechain/sdk-errors";
...
import { ADDRESS, assert as assert15, BLOOM, DATA as DATA6 } from "@vechain/sdk-errors";
...
import { assert as assert16, buildError as buildError5, DATA as DATA7 } from "@vechain/sdk-errors";
...
import { assert as assert18, buildError as buildError6, DATA as DATA9 } from "@vechain/sdk-errors";
  ...
  switch (typeof value) {
    ...
    case "string": {
      if (Hex0x.isValid(value)) {
        bn = BigNumber(hexToNumber(Hex.canon(value)).toString());
      } else {
        bn = BigNumber(value);
      }
    }
...
import { assert as assert21, buildError as buildError7, CERTIFICATE } from "@vechain/sdk-errors";
...
import { assert as assert22, buildError as buildError8, DATA as DATA10 } from "@vechain/sdk-errors";
...
import { assert as assert23, buildError as buildError10, KEYSTORE } from "@vechain/sdk-errors";
...
function isValid(keystore4) {
  return ethers3.isKeystoreJson(JSON.stringify(keystore4));
}
var keystore = { encrypt, decrypt, isValid };

// src/keystore/cryptography/experimental/keystore.ts
import { assert as assert24, KEYSTORE as KEYSTORE2 } from "@vechain/sdk-errors";
...
import { assert as assert25, buildError as buildError11, HDNODE as HDNODE2 } from "@vechain/sdk-errors";
...
function isValid4(words) {
  return bip392.validateMnemonic(words.join(" "), wordlist);
}
var mnemonic = {
  deriveAddress,
  derivePrivateKey,

 ...
 */
declare function functionInteraction(contractAddress: string, functionFragment: FunctionFragment, args: unknown[], value?: number): TransactionClause;
/**
 ...
 */
declare function fromMnemonic(words: string[], path?: string): bip32.HDKey;
/**
 * Creates a [BIP32 Hierarchical Deterministic Key](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
 ...
 */
declare function fromPrivateKey(privateKey: Uint8Array, chainCode: Uint8Array): bip32.HDKey;
/**
 * Creates a [BIP32 Hierarchical Deterministic Key](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
 ...
 */
declare function fromPublicKey(publicKey: Uint8Array, chainCode: Uint8Array): bip32.HDKey;
...
declare const bloomUtils: {
    ...
    addressesOf: (block: ExpandedBlockDetail) => string[];
